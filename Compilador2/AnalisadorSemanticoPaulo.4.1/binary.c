...
const char * opcodes[] =  { "nop", "halt", "add", "sub",   //1
...
const char * opcodeBins[] =  {  "000000", "000001", "000010", "000011", //1
                                "000100", "000101", "000110", "000111", //2
                                "001000","001001", "001010", "001011", //3
                                "001100", "001101", "001110", "010000", //4
                                "010001", "010010", "010100", "010101", //5
                                "010110", "010111", "011000", "011011", //6
                                "011100", "011101", "001111", "011001",//7
                                "011010", "010011"}; //8
...
void generateBinary (AssemblyCode head, int size) {
    ...
    while (a != NULL) {
        if (a->kind == instr) {
            fprintf(c, "\tmemoria[%d]\t=\t32'b", a->lineno);
            printf("%d:\t", a->lineno);
