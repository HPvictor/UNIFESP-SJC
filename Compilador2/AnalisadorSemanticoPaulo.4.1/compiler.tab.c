...
{
       0,    43,    43,    48,    58,    63,    65,    72,    87,    91,
     100,   112,   124,   136,   151,   165,   182,   184,   192,   202,
     207,   218,   230,   229,   245,   255,   257,   259,   264,   274,
     279,   289,   294,   296,   298,   300,   302,   307,   309,   314,
     320,   330,   339,   342,   349,   356,   361,   367,   377,   383,
     388,   392,   396,   400,   404,   408,   415,   421,   426,   430,
     437,   443,   448,   452,   459,   461,   463,   467,   474,   485,
     498,   509
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GT", "GET", "EQ", "NEQ", "ASSIGN", "SEMI", "VIRG", "LPAREN", "RPAREN",
  "CONOPEN", "CONCLOSE", "CHAVEOPEN", "CHAVECLOSE", "ERROR", "$accept",
...
/* Copy to YYRES the contents of YYSTR after stripping away unnecessary
   ...
   contains an apostrophe, a VIRG, or backslash (other than
...
#line 73 "compiler.y" /* yacc.c:1646  */
    ...
    (yyval)->nameID = copyString(tokenString);
    savedName = copyString(tokenString);
    (yyval)->typeID = typeID;
    (yyval)->typedata = typedata;
    (yyval)->scope = scope;
    (yyval)->declared = 0;
    (yyval)->vet = -1;
    (yyval)->params = params;
...
#line 101 "compiler.y" /* yacc.c:1646  */
    ...
    (yyval)->typeID = "decl";
    (yyval)->nameID = (yyvsp[-1])->attr.name;
    (yyval)->typedata = "int";
    (yyval)->scope = scope;
    (yyval)->declared = 1;
    (yyval)->vet = -1;
...
#line 113 "compiler.y" /* yacc.c:1646  */
    ...
    (yyval)->typeID = "decl";
    (yyval)->nameID = (yyvsp[-4])->attr.name;
    (yyval)->typedata = "int";
    (yyval)->scope = scope;
    (yyval)->declared = 1;
...
#line 208 "compiler.y" /* yacc.c:1646  */
    { (yyval) = newExpNode(ParametrosK);
    (yyval)->attr.name = (yyvsp[0])->attr.name;
    (yyval)->nameID = (yyvsp[0])->attr.name;
    (yyval)->typeID = "param";
    (yyval)->typedata = "int";
    (yyval)->scope = scope;
    (yyval)->declared = 1;
...
#line 219 "compiler.y" /* yacc.c:1646  */
    ...
    (yyval)->nameID = (yyvsp[-2])->attr.name;
    (yyval)->typeID = "param";
    (yyval)->typedata = "int";
    (yyval)->scope = scope;
    (yyval)->declared = 1;
...
#line 1919 "compiler.tab.c" /* yacc.c:1646  */
    break;
...
#line 462 "compiler.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[0]); }
#line 1931 "compiler.tab.c" /* yacc.c:1646  */
    break;
...
#line 475 "compiler.y" /* yacc.c:1646  */
    { (yyval) = newExpNode(AtivacaoK);
    (yyval)->attr.name = (yyvsp[-3])->attr.name;
    (yyval)->nameID = (yyvsp[-3])->attr.name;
    (yyval)->scope = scope;
    (yyval)->declared = 0;
    (yyval)->typeID = "call";
    (yyval)->vet = -1;
